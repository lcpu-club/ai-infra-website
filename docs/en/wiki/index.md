---
title: "AI Infra Seminars Wiki"
description: "Course materials for Weiming HPC Training Camp × LCPU AI Infrastructure Seminars"
outline: deep
lastUpdated: false
---
...
The seminar moves from a single GPU kernel to the system architecture behind
large-scale model training, inference, and reinforcement learning.

| Topic | Weeks | Main subjects |
| --- | --- | --- |
| [Kernel and ML Compilers](/en/wiki/VWJPwVFTHifeadkE4phc45hOntg) | 1–3 | GPU programming, memory hierarchy, Tensor Cores and layouts, software pipelines, GPU DSLs, ML compilers, and state-of-the-art kernels |
...
Guest lectures complement each topic with perspectives from current research and
production systems.
